## [Python __name__ 与 __main__](https://www.runoob.com/python3/python3-name-main.html)

[index](目录.md)

---
Python \_\_name\_\_ 与 \_\_main\_\_
==================================
...
和
\_\_main\_
\_ 通常用于控制代码的执行方式，尤其是在模块既可以作为独立脚本运行，也可以被其他模块导入时。
...
\_\_main\_\_
通常与 \_\_name\_\_ 变量一起使用，以确定模块是被导入还是作为独立脚本运行。

### 3. 使用 if \_\_name\_\_ == "\_\_main\_\_": 的常见模式
