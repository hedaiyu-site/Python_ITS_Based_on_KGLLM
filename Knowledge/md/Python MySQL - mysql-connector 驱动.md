...
[MySQL 教程。](/mysql/mysql-tutorial.html)
...
> 注
> **意：**
> 如果你的 MySQL 是 8.0 版本，密码插件验证方式发生了变化，早期版本为 mysql\_native\_password，8.0 版本为 caching\_sha2\_password，所以需要做些改变：
>
> 先修改 my.ini 配置：
>
> ```
...
>
> 更多内容可以参考：
> [Python MySQL8.0 链接问题](https://www.runoob.com/note/45833)
> 。
