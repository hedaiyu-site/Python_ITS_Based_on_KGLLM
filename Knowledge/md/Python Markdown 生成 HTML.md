## [Python Markdown 生成 HTML](https://www.runoob.com/python3/python-markdown2html.html)
...
convert\_markdown\_to\_html.py 文件代码：
------------------------------------
...
：这行代码导入了
`markdown`
库，它提供了将 Markdown 文本转换为 HTML 的功能。
...
**html = markdown.markdown(markdown\_text)**
：这行代码使用
`markdown.markdown()`
函数将 Markdown 文本转换为 HTML 文本。
