## [Python with 关键字](https://www.runoob.com/python3/python3-with-keyword.html)
...
`with`
语句是 Python 中一项强大的特性，它不仅能简化代码，还能提高程序的健壮性。掌握
`with`
语句的使用和原理，将帮助你写出更专业、更可靠的 Python 代码。